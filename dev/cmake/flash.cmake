...
add_custom_command(OUTPUT ${PROJECT_NAME}.srec
    ...
    COMMAND ${CMAKE_OBJCOPY} -Osrec ${EXECUTABLE_NAME} ${PROJECT_NAME}.srec
)
add_custom_command(OUTPUT ${PROJECT_NAME}.hex
    WORKING_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}
    DEPENDS ${EXECUTABLE_NAME}
    COMMAND ${CMAKE_OBJCOPY} -Oihex ${EXECUTABLE_NAME} ${PROJECT_NAME}.hex
)
add_custom_command(OUTPUT ${PROJECT_NAME}.bin
    WORKING_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}
    DEPENDS ${EXECUTABLE_NAME}
    COMMAND ${CMAKE_OBJCOPY} -Obinary ${EXECUTABLE_NAME} ${PROJECT_NAME}.bin
)
add_custom_command(OUTPUT ${PROJECT_NAME}.lst
    WORKING_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}
    DEPENDS ${EXECUTABLE_NAME}
    COMMAND ${CMAKE_OBJDUMP} -S ${EXECUTABLE_NAME} > ${PROJECT_NAME}.lst
)
add_custom_command(OUTPUT ${PROJECT_NAME}.sym
    WORKING_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}
    DEPENDS ${EXECUTABLE_NAME}
    COMMAND ${CMAKE_NM} -C -l -n -S ${EXECUTABLE_NAME} > ${PROJECT_NAME}.sym
)
